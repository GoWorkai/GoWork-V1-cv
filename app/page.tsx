...
export default function Home() {
  ...
  const handleDemoLogin = async () => {
    try {
      const result = await authService.login("demo@gowork.com", "demo123")
      if (result.success) {
